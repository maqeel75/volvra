...
[![test](https://github.com/pgEdge/volvra/actions/workflows/test.yml/badge.svg)](https://github.com/pgEdge/volvra/actions/workflows/test.yml)
...
Volvra reverts the exact rows changed by a mistaken UPDATE, DELETE, or
...
Install Volvra by running one file against your database:
...
Volvra is not a PostgreSQL extension, and nothing depends on that
packaging.

## Configuration

Volvra works with no configuration. Settings live in the
